...
// case: {"id": "s08", "name": "s08_node_barrier", "nodes": ["A", "B", "D", "C"], "edges": {"C": ["A", "B"], "D": ["B"]}, "context_partition": [["A"], ["B"], ["C"], ["D"]], "resource_config": {"uce": 4, "device": 4, "placement": 15, "fidelity": "full_memory"}, "expected": {"时序/生命周期 Correctness": "检查全部真实输入边、完整 Store/release 依赖和 Context 完成", "数值": "未建模；隐式 L1 output timing，仅作合成 compute-cost 扫描", "Liveness": "预期完成", "Scheduling Quality": "FAIL：刻意等待 A/B Context 后再连续 submit C、D；工作量和硬件与正例相同"}, "forbidden_dependencies": "仅允许 edges 与外部输入；跨 Context 使用当前 IR 的保守 context_done 可见性", "tensors": {"input_A": {"index": 0, "offset_elements": 0, "bytes": 32768}, "W_A": {"index": 1, "offset_elements": 131072, "bytes": 32768}, "input_B": {"index": 2, "offset_elements": 262144, "bytes": 32768}, "A": {"index": 3, "offset_elements": 393216, "bytes": 32768}, "B": {"index": 4, "offset_elements": 524288, "bytes": 32768}, "D": {"index": 5, "offset_elements": 655360, "bytes": 32768}, "C": {"index": 6, "offset_elements": 786432, "bytes": 32768}}, "node_programs": {"A": {"program": "prog_A", "pin": "随 device slot", "engine": "boa", "op": "matmul", "repeat": 100, "loads": 1}, "B": {"program": "prog_B", "pin": "随 device slot", "engine": "evu", "op": "pow", "repeat": 5, "loads": 1}, "D": {"program": "prog_D", "pin": "随 device slot", "engine": "evu", "op": "pow", "repeat": 90, "loads": 1}, "C": {"program": "prog_C", "pin": "随 device slot", "engine": "evu", "op": "add", "repeat": 5, "loads": 1}}, "consumer_ready": {"A": ["input_A.prefetch", "W_A.prefetch"], "B": ["input_B.prefetch"], "D": ["B.context_done 后从同一 HBM 区间 prefetch"], "C": ["A.context_done 后从同一 HBM 区间 prefetch", "B.context_done 后从同一 HBM 区间 prefetch"]}, "说明": "D 没有 C 依赖，也不等待 C Context 完成；反例只把 C 的 A/B 必要等待移到 D 提交之前。"}
builtin.module {
