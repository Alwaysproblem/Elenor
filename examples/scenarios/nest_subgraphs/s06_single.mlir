...
//       "consumer_ready": {
//         "A": ["input_A.prefetch"],
//         "B": ["A.output_ready", "W_B.prefetch"],
//         "C": ["A.output_ready"],
//         "D": ["C.output_ready"],
//         "J": ["B.output_ready", "D.output_ready"]
//       }
//     }
builtin.module {
  tile.program @prog_A(
  ...
  nest.context @ctx_0 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    nest.await %grid_A, %grid_B, %grid_C, %grid_D, %grid_J, %store_A_0, %store_B_0, %store_C_0,
      %store_D_0, %store_J_0
    nest.return
  }
