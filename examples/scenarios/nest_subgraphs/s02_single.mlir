...
builtin.module {
  ...
  nest.context @ctx_0 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    nest.await %grid_A0, %grid_B0, %grid_C0, %grid_B1, %grid_C1, %grid_C2, %grid_A1, %grid_A2,
      %store_A0_0, %store_B0_0, %store_C0_0, %store_B1_0, %store_C1_0, %store_C2_0, %store_A1_0,
      %store_A2_0
    nest.return
  }
