...
// case: {"id": "s11", "name": "s11_stage", "nodes": ["P0", "P1", "P2", "P3", "R0", "R1", "R", "N0", "N1", "N2", "N3"], "edges": {"R0": ["P0", "P1"], "R1": ["P2", "P3"], "R": ["R0", "R1"], "N0": ["R"], "N1": ["R"], "N2": ["R"], "N3": ["R"]}, "context_partition": [["P0", "P1", "R0"], ["P2", "P3", "R1"], ["R"], ["N0", "N1", "N2", "N3"]], "resource_config": {"uce": 4, "device": 4, "placement": 15, "fidelity": "full_memory"}, "expected": {"时序/生命周期 Correctness": "检查全部真实输入边、完整 Store/release 依赖和 Context 完成", "数值": "未建模；隐式 L1 output timing，仅作合成 compute-cost 扫描", "Liveness": "预期完成", "Scheduling Quality": "以实际 service 判定；不把 issue/slot 占用冒充有效重叠"}, "forbidden_dependencies": "仅允许 edges 与外部输入；跨 Context 使用当前 IR 的保守 context_done 可见性", "tensors": {"input_P0": {"index": 0, "offset_elements": 0, "bytes": 32768}, "W_P0": {"index": 1, "offset_elements": 131072, "bytes": 32768}, "input_P1": {"index": 2, "offset_elements": 262144, "bytes": 32768}, "W_P1": {"index": 3, "offset_elements": 393216, "bytes": 32768}, "input_P2": {"index": 4, "offset_elements": 524288, "bytes": 32768}, "W_P2": {"index": 5, "offset_elements": 655360, "bytes": 32768}, "input_P3": {"index": 6, "offset_elements": 786432, "bytes": 32768}, "W_P3": {"index": 7, "offset_elements": 917504, "bytes": 32768}, "P0": {"index": 8, "offset_elements": 1048576, "bytes": 32768}, "P1": {"index": 9, "offset_elements": 1179648, "bytes": 32768}, "P2": {"index": 10, "offset_elements": 1310720, "bytes": 32768}, "P3": {"index": 11, "offset_elements": 1441792, "bytes": 32768}, "R0": {"index": 12, "offset_elements": 1572864, "bytes": 32768}, "R1": {"index": 13, "offset_elements": 1703936, "bytes": 32768}, "R": {"index": 14, "offset_elements": 1835008, "bytes": 32768}, "N0": {"index": 15, "offset_elements": 1966080, "bytes": 32768}, "N1": {"index": 16, "offset_elements": 2097152, "bytes": 32768}, "N2": {"index": 17, "offset_elements": 2228224, "bytes": 32768}, "N3": {"index": 18, "offset_elements": 2359296, "bytes": 32768}}, "node_programs": {"P0": {"program": "prog_P0", "pin": 0, "engine": "boa", "op": "matmul", "repeat": 1, "loads": 1}, "P1": {"program": "prog_P1", "pin": 1, "engine": "boa", "op": "matmul", "repeat": 1, "loads": 1}, "P2": {"program": "prog_P2", "pin": 2, "engine": "boa", "op": "matmul", "repeat": 1, "loads": 1}, "P3": {"program": "prog_P3", "pin": 3, "engine": "boa", "op": "matmul", "repeat": 1, "loads": 1}, "R0": {"program": "prog_R0", "pin": 0, "engine": "evu", "op": "reduce", "repeat": 1, "loads": 1}, "R1": {"program": "prog_R1", "pin": 2, "engine": "evu", "op": "reduce", "repeat": 1, "loads": 1}, "R": {"program": "prog_R", "pin": 0, "engine": "evu", "op": "reduce", "repeat": 1, "loads": 1}, "N0": {"program": "prog_N0", "pin": 0, "engine": "copy", "op": "copy", "repeat": 1, "loads": 1}, "N1": {"program": "prog_N1", "pin": 1, "engine": "copy", "op": "copy", "repeat": 1, "loads": 1}, "N2": {"program": "prog_N2", "pin": 2, "engine": "copy", "op": "copy", "repeat": 1, "loads": 1}, "N3": {"program": "prog_N3", "pin": 3, "engine": "copy", "op": "copy", "repeat": 1, "loads": 1}}, "consumer_ready": {"P0": ["input_P0.prefetch", "W_P0.prefetch"], "P1": ["input_P1.prefetch", "W_P1.prefetch"], "P2": ["input_P2.prefetch", "W_P2.prefetch"], "P3": ["input_P3.prefetch", "W_P3.prefetch"], "R0": ["P0.output_ready", "P1.output_ready"], "R1": ["P2.output_ready", "P3.output_ready"], "R": ["R0.context_done 后从同一 HBM 区间 prefetch", "R1.context_done 后从同一 HBM 区间 prefetch"], "N0": ["R.context_done 后从同一 HBM 区间 prefetch"], "N1": ["R.context_done 后从同一 HBM 区间 prefetch"], "N2": ["R.context_done 后从同一 HBM 区间 prefetch"], "N3": ["R.context_done 后从同一 HBM 区间 prefetch"]}}
builtin.module {
  ...
  nest.context @ctx_2 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    %tasks = nest.task.range from = 0 to = 4 : !nest.task_range
    %grid_R, %read_R, %ready_R = nest.dispatch.tasks.async @prog_R context = 0 tasks(%tasks) globals() ins(%b_R0, %b_R1, %b_R) outs(%b_R0, %b_R1, %b_R) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%pref_R0, %pref_R1) : (!nest.event<"grid_R">, !nest.event<"read_R">, !nest.event<"ready_R">)
  ...
  nest.context @ctx_3 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    %tasks = nest.task.range from = 0 to = 4 : !nest.task_range
    %grid_N0, %read_N0, %ready_N0 = nest.dispatch.tasks.async @prog_N0 context = 0 tasks(%tasks) globals() ins(%b_R, %b_N0) outs(%b_R, %b_N0) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%pref_R) : (!nest.event<"grid_N0">, !nest.event<"read_N0">, !nest.event<"ready_N0">)
    %grid_N1, %read_N1, %ready_N1 = nest.dispatch.tasks.async @prog_N1 context = 1 tasks(%tasks) globals() ins(%b_R, %b_N1) outs(%b_R, %b_N1) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%pref_R) : (!nest.event<"grid_N1">, !nest.event<"read_N1">, !nest.event<"ready_N1">)
    %grid_N2, %read_N2, %ready_N2 = nest.dispatch.tasks.async @prog_N2 context = 2 tasks(%tasks) globals() ins(%b_R, %b_N2) outs(%b_R, %b_N2) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%pref_R) : (!nest.event<"grid_N2">, !nest.event<"read_N2">, !nest.event<"ready_N2">)
    %grid_N3, %read_N3, %ready_N3 = nest.dispatch.tasks.async @prog_N3 context = 3 tasks(%tasks) globals() ins(%b_R, %b_N3) outs(%b_R, %b_N3) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%pref_R) : (!nest.event<"grid_N3">, !nest.event<"read_N3">, !nest.event<"ready_N3">)
    nest.release %b_R depends_on(%read_N0, %read_N1, %read_N2, %read_N3)
    ...
    nest.await %grid_N0, %grid_N1, %grid_N2, %grid_N3, %store_N0_0, %store_N1_0, %store_N2_0, %store_N3_0
    nest.return
  }
