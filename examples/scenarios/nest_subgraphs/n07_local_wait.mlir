...
//       },
//       "forbidden_dependencies": "ctx_0 的局部 await 不得冻结 ctx_1；B 不得越过 grid_A",
//       "tensors": {
//         "X": {
//           "index": 0,
//           "offset_elements": 0,
...
//       "phase": {
//         "A": ["pref_X"],
//         "B": ["ready_A", "grid_A local PC await"],
//         "C": ["pref_C_input"]
//       },
//       "pins": {
//         "A": 0,
...
builtin.module {
  ...
  nest.context @ctx_1 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    %b_C = nest.alloc slot = "C" role = "inout" shape = [4, 64, 64] dtype = "bf16" alignment = 256
      : !nest.l2_buffer<4x64x64xbf16>
    %h_C_input = nest.subview %arena offsets = [131072] sizes = [16384] strides = [1]
      : !nest.global_view<16384xbf16>
