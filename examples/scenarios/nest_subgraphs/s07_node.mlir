...
// case: {"id": "s07", "name": "s07_node", "nodes": ["A", "B", "C", "D", "E", "F", "G"], "edges": {"B": ["A"], "C": ["A"], "D": ["B"], "E": ["B"], "F": ["D", "E"], "G": ["F", "C"]}, "context_partition": [["A"], ["B"], ["C"], ["D"], ["E"], ["F"], ["G"]], "resource_config": {"uce": 4, "device": 4, "placement": 15, "fidelity": "full_memory"}, "expected": {"时序/生命周期 Correctness": "检查全部真实输入边、完整 Store/release 依赖和 Context 完成", "数值": "未建模；隐式 L1 output timing，仅作合成 compute-cost 扫描", "Liveness": "预期完成", "Scheduling Quality": "以实际 service 判定；不把 issue/slot 占用冒充有效重叠"}, "forbidden_dependencies": "仅允许 edges 与外部输入；跨 Context 使用当前 IR 的保守 context_done 可见性", "tensors": {"input_A": {"index": 0, "offset_elements": 0, "bytes": 32768}, "W_C": {"index": 1, "offset_elements": 131072, "bytes": 32768}, "A": {"index": 2, "offset_elements": 262144, "bytes": 32768}, "B": {"index": 3, "offset_elements": 393216, "bytes": 32768}, "C": {"index": 4, "offset_elements": 524288, "bytes": 32768}, "D": {"index": 5, "offset_elements": 655360, "bytes": 32768}, "E": {"index": 6, "offset_elements": 786432, "bytes": 32768}, "F": {"index": 7, "offset_elements": 917504, "bytes": 32768}, "G": {"index": 8, "offset_elements": 1048576, "bytes": 32768}}, "node_programs": {"A": {"program": "prog_A", "pin": "随 device slot", "engine": "evu", "op": "relu", "repeat": 1, "loads": 1}, "B": {"program": "prog_B", "pin": "随 device slot", "engine": "evu", "op": "relu", "repeat": 1, "loads": 1}, "C": {"program": "prog_C", "pin": "随 device slot", "engine": "boa", "op": "matmul", "repeat": 1, "loads": 1}, "D": {"program": "prog_D", "pin": "随 device slot", "engine": "evu", "op": "relu", "repeat": 1, "loads": 1}, "E": {"program": "prog_E", "pin": "随 device slot", "engine": "evu", "op": "relu", "repeat": 1, "loads": 1}, "F": {"program": "prog_F", "pin": "随 device slot", "engine": "evu", "op": "relu", "repeat": 1, "loads": 1}, "G": {"program": "prog_G", "pin": "随 device slot", "engine": "evu", "op": "add", "repeat": 1, "loads": 1}}, "consumer_ready": {"A": ["input_A.prefetch"], "B": ["A.context_done 后从同一 HBM 区间 prefetch"], "C": ["A.context_done 后从同一 HBM 区间 prefetch", "W_C.prefetch"], "D": ["B.context_done 后从同一 HBM 区间 prefetch"], "E": ["B.context_done 后从同一 HBM 区间 prefetch"], "F": ["D.context_done 后从同一 HBM 区间 prefetch", "E.context_done 后从同一 HBM 区间 prefetch"], "G": ["F.context_done 后从同一 HBM 区间 prefetch", "C.context_done 后从同一 HBM 区间 prefetch"]}}
builtin.module {
