...
//         "D2": ["E2.output_ready"],
//         "D1": ["D2.output_ready", "E1.output_ready"],
//         "D0": ["D1.output_ready", "E0.output_ready"]
//       }
//     }
builtin.module {
  ...
  nest.context @ctx_0 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    nest.await %grid_E0, %grid_E1, %grid_E2, %grid_D2, %grid_D1, %grid_D0, %store_E0_0, %store_E1_0,
      %store_E2_0, %store_D2_0, %store_D1_0, %store_D0_0
    nest.return
  }
