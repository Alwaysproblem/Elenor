...
builtin.module {
  ...
  tile.program @prog_B (%task: !nest.task, %i0: !nest.l2_buffer<4x64x64xbf16>, %i1: !nest.l2_buffer<4x64x64xbf16>, %out: !nest.l2_buffer<4x64x64xbf16>) {
    ...
    %load_1_1 = tile.load.async %v1 into %l1 : !tile.event<"load_1_1">
    tile.await %load_1_0, %load_1_1
    %load_2_0 = tile.load.async %v0 into %l0 : !tile.event<"load_2_0">
    %load_2_1 = tile.load.async %v1 into %l1 : !tile.event<"load_2_1">
    tile.await %load_2_0, %load_2_1
    %load_3_0 = tile.load.async %v0 into %l0 : !tile.event<"load_3_0">
    %load_3_1 = tile.load.async %v1 into %l1 : !tile.event<"load_3_1">
    tile.await %load_3_0, %load_3_1
    %load_4_0 = tile.load.async %v0 into %l0 : !tile.event<"load_4_0">
    %load_4_1 = tile.load.async %v1 into %l1 : !tile.event<"load_4_1">
    tile.await %load_4_0, %load_4_1
    %load_5_0 = tile.load.async %v0 into %l0 : !tile.event<"load_5_0">
    %load_5_1 = tile.load.async %v1 into %l1 : !tile.event<"load_5_1">
    tile.await %load_5_0, %load_5_1
    %load_6_0 = tile.load.async %v0 into %l0 : !tile.event<"load_6_0">
    %load_6_1 = tile.load.async %v1 into %l1 : !tile.event<"load_6_1">
    tile.await %load_6_0, %load_6_1
    %load_7_0 = tile.load.async %v0 into %l0 : !tile.event<"load_7_0">
    %load_7_1 = tile.load.async %v1 into %l1 : !tile.event<"load_7_1">
    tile.await %load_7_0, %load_7_1
    %load_8_0 = tile.load.async %v0 into %l0 : !tile.event<"load_8_0">
    %load_8_1 = tile.load.async %v1 into %l1 : !tile.event<"load_8_1">
    tile.await %load_8_0, %load_8_1
    %load_9_0 = tile.load.async %v0 into %l0 : !tile.event<"load_9_0">
    %load_9_1 = tile.load.async %v1 into %l1 : !tile.event<"load_9_1">
    tile.await %load_9_0, %load_9_1
    tile.signal input_released(%task)
