...
//       },
//       "expected": {
//         "Correctness": "检查真实数据边与生命周期",
//         "数值": "未建模；隐式 L1 output timing，合成 compute-cost 扫描",
//         "Liveness": "完成（short 为永久容量 fault）",
//         "Scheduling Quality": "barrier 为反例；其余以实测 service 判定，不保证最优"
//       },
//       "forbidden_dependencies": "仅真前驱；跨 Context context_done 为当前 IR 保守降级",
//       "tensors": {
//         "input_A": {
//           "index": 0,
//           "offset_elements": 0,
