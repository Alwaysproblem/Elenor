...
//         "C": ["input_C.prefetch"],
//         "D": [
//           "A.context_done 后从同一 HBM 区间 prefetch",
//           "B.context_done 后从同一 HBM 区间 prefetch",
//           "C.context_done 后从同一 HBM 区间 prefetch"
//         ]
//       },
//       "说明": "三个独立根 A/B/C 的 repeat=(10, 100, 1)；D 仍等待三个 distinct producer。"
//     }
builtin.module {
  tile.program @prog_A(
  ...
  tile.program @prog_B(
    ...
    tile.await %compute_9
    %compute_10 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_10">
    tile.await %compute_10
    %compute_11 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_11">
    tile.await %compute_11
    %compute_12 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_12">
    tile.await %compute_12
    %compute_13 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_13">
    tile.await %compute_13
    %compute_14 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_14">
    tile.await %compute_14
    %compute_15 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_15">
    tile.await %compute_15
    %compute_16 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_16">
    tile.await %compute_16
    %compute_17 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_17">
    tile.await %compute_17
    %compute_18 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_18">
    tile.await %compute_18
    %compute_19 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_19">
    tile.await %compute_19
    %compute_20 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_20">
    tile.await %compute_20
    %compute_21 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_21">
    tile.await %compute_21
    %compute_22 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_22">
    tile.await %compute_22
    %compute_23 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_23">
    tile.await %compute_23
    %compute_24 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_24">
    tile.await %compute_24
    %compute_25 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_25">
    tile.await %compute_25
    %compute_26 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_26">
    tile.await %compute_26
    %compute_27 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_27">
    tile.await %compute_27
    %compute_28 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_28">
    tile.await %compute_28
    %compute_29 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_29">
    tile.await %compute_29
    %compute_30 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_30">
    tile.await %compute_30
    %compute_31 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_31">
    tile.await %compute_31
    %compute_32 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_32">
    tile.await %compute_32
    %compute_33 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_33">
    tile.await %compute_33
    %compute_34 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_34">
    tile.await %compute_34
    %compute_35 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_35">
    tile.await %compute_35
    %compute_36 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_36">
    tile.await %compute_36
    %compute_37 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_37">
    tile.await %compute_37
    %compute_38 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_38">
    tile.await %compute_38
    %compute_39 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_39">
    tile.await %compute_39
    %compute_40 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_40">
    tile.await %compute_40
    %compute_41 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_41">
    tile.await %compute_41
    %compute_42 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_42">
    tile.await %compute_42
    %compute_43 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_43">
    tile.await %compute_43
    %compute_44 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_44">
    tile.await %compute_44
    %compute_45 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_45">
    tile.await %compute_45
    %compute_46 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_46">
    tile.await %compute_46
    %compute_47 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_47">
    tile.await %compute_47
    %compute_48 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_48">
    tile.await %compute_48
    %compute_49 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_49">
    tile.await %compute_49
    %compute_50 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_50">
    tile.await %compute_50
    %compute_51 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_51">
    tile.await %compute_51
    %compute_52 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_52">
    tile.await %compute_52
    %compute_53 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_53">
    tile.await %compute_53
    %compute_54 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_54">
    tile.await %compute_54
    %compute_55 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_55">
    tile.await %compute_55
    %compute_56 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_56">
    tile.await %compute_56
    %compute_57 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_57">
    tile.await %compute_57
    %compute_58 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_58">
    tile.await %compute_58
    %compute_59 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_59">
    tile.await %compute_59
    %compute_60 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_60">
    tile.await %compute_60
    %compute_61 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_61">
    tile.await %compute_61
    %compute_62 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_62">
    tile.await %compute_62
    %compute_63 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_63">
    tile.await %compute_63
    %compute_64 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_64">
    tile.await %compute_64
    %compute_65 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_65">
    tile.await %compute_65
    %compute_66 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_66">
    tile.await %compute_66
    %compute_67 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_67">
    tile.await %compute_67
    %compute_68 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_68">
    tile.await %compute_68
    %compute_69 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_69">
    tile.await %compute_69
    %compute_70 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_70">
    tile.await %compute_70
    %compute_71 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_71">
    tile.await %compute_71
    %compute_72 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_72">
    tile.await %compute_72
    %compute_73 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_73">
    tile.await %compute_73
    %compute_74 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_74">
    tile.await %compute_74
    %compute_75 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_75">
    tile.await %compute_75
    %compute_76 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_76">
    tile.await %compute_76
    %compute_77 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_77">
    tile.await %compute_77
    %compute_78 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_78">
    tile.await %compute_78
    %compute_79 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_79">
    tile.await %compute_79
    %compute_80 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_80">
    tile.await %compute_80
    %compute_81 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_81">
    tile.await %compute_81
    %compute_82 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_82">
    tile.await %compute_82
    %compute_83 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_83">
    tile.await %compute_83
    %compute_84 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_84">
    tile.await %compute_84
    %compute_85 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_85">
    tile.await %compute_85
    %compute_86 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_86">
    tile.await %compute_86
    %compute_87 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_87">
    tile.await %compute_87
    %compute_88 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_88">
    tile.await %compute_88
    %compute_89 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_89">
    tile.await %compute_89
    %compute_90 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_90">
    tile.await %compute_90
    %compute_91 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_91">
    tile.await %compute_91
    %compute_92 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_92">
    tile.await %compute_92
    %compute_93 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_93">
    tile.await %compute_93
    %compute_94 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_94">
    tile.await %compute_94
    %compute_95 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_95">
    tile.await %compute_95
    %compute_96 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_96">
    tile.await %compute_96
    %compute_97 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_97">
    tile.await %compute_97
    %compute_98 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
      : !tile.event<"compute_98">
    tile.await %compute_98
    %compute_99 = tile.pow.async bytes = 8192 exponent = 2 pow_ops = 16448
  ...
  nest.context @ctx_1 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    %b_input_B = nest.alloc slot = "input_B" role = "in" shape = [4, 64, 64] dtype = "bf16"
      alignment = 256 : !nest.l2_buffer<4x64x64xbf16>
    %h_input_B = nest.subview %arena offsets = [262144] sizes = [16384] strides = [1]
      : !nest.global_view<16384xbf16>
    ...
    %grid_B, %read_B, %ready_B = nest.dispatch.tasks.async @prog_B tasks(%tasks) globals()
      bindings(%b_input_B, %b_B) ins(%b_input_B) outs(%b_B)
      signal_policy {
        input_released = #nest.aggregate<all_tasks>
        output_ready = #nest.aggregate<all_tasks>
      } depends_on(%pref_input_B)
  ...
  nest.context @ctx_2 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    %grid_C, %read_C, %ready_C = nest.dispatch.tasks.async @prog_C tasks(%tasks) globals()
      bindings(%b_input_C, %b_C) ins(%b_input_C) outs(%b_C)
      signal_policy {
        input_released = #nest.aggregate<all_tasks>
        output_ready = #nest.aggregate<all_tasks>
      } depends_on(%pref_input_C)
      : (!nest.event<"grid_C">, !nest.event<"read_C">, !nest.event<"ready_C">)
    nest.release %b_input_C depends_on(%read_C, %pref_input_C)
  ...
  nest.context @ctx_3 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    %grid_D, %read_D, %ready_D = nest.dispatch.tasks.async @prog_D tasks(%tasks) globals()
      bindings(%b_A, %b_B, %b_C, %b_D) ins(%b_A, %b_B, %b_C) outs(%b_D)
      signal_policy {
        input_released = #nest.aggregate<all_tasks>
        output_ready = #nest.aggregate<all_tasks>
      } depends_on(%pref_A, %pref_B, %pref_C)
      : (!nest.event<"grid_D">, !nest.event<"read_D">, !nest.event<"ready_D">)
    nest.release %b_A depends_on(%read_D, %pref_A)
