...
// case: {"id":"t03","name":"t03_node_one","nodes":["Step0"],"edges":{},"context_partition":[["Step0"]],"resource_config":{"uce_context_mode":4,"device_context_mode":4,"placement":15,"fidelity":"full_memory","arena_binding":"arena=0x1000000:8388608:rw"},"expected":{"时序/生命周期 Correctness":"检查真实 HBM/L2 数据边、input_released/output_ready、最终 Store 与释放顺序","数值":"未建模；仅使用真实搬运和合成 engine service，不作为 tensor 数值证明","Liveness":"应完成；以同次运行 trace 和退出状态确认","Scheduling Quality":"1 次静态展开；活动 grid 数应为 1，不得解释为运行时 early-exit"},"forbidden_dependencies":"只允许表列真数据边；UCE 共享 pin 争用不是数据依赖；跨 Context 仅使用当前 IR 可见的 context_done/HBM 可见性","tensors":{"State0":{"formal":"arena","index":0,"offset_elements":0,"interval_bytes":[0,32768],"bytes":32768},"Input0":{"formal":"arena","index":1,"offset_elements":131072,"interval_bytes":[262144,294912],"bytes":32768},"State1":{"formal":"arena","index":5,"offset_elements":655360,"interval_bytes":[1310720,1343488],"bytes":32768}},"node_programs":{"Step0":{"program":"prog_Step0","pin":"跟随 device slot","engine":"EVU:add","repeat":1}},"consumer_ready_granularity":{"State0->Step0":"prefetch 完成","Input0->Step0":"prefetch 完成"},"notes":{"iteration_count":1,"event_tags":["iteration_0"],"zero_case":null,"stable_tensor_indices":{"State0":0,"Input0":1,"Input1":2,"Input2":3,"Input3":4,"State1":5,"State2":6,"State3":7,"State4":8}}}
builtin.module {
