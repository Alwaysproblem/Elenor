...
builtin.module {
  ...
  nest.context @ctx_all_requests(
    ...
    %b_R0_input = nest.alloc slot = "R0_input" role = "in" shape = [4, 64, 64] dtype = "bf16"
      alignment = 256 : !nest.l2_buffer<4x64x64xbf16>
    %h_R0_input = nest.subview %R0 offsets = [0] sizes = [16384] strides = [1]
      : !nest.global_view<16384xbf16>
    %b_R0_A = nest.alloc slot = "R0_A" role = "inout" shape = [4, 64, 64] dtype = "bf16"
      alignment = 256 : !nest.l2_buffer<4x64x64xbf16>
    %h_R0_A = nest.subview %R0 offsets = [131072] sizes = [16384] strides = [1]
      : !nest.global_view<16384xbf16>
    %b_R0_B = nest.alloc slot = "R0_B" role = "inout" shape = [4, 64, 64] dtype = "bf16"
      alignment = 256 : !nest.l2_buffer<4x64x64xbf16>
    %h_R0_B = nest.subview %R0 offsets = [262144] sizes = [16384] strides = [1]
      : !nest.global_view<16384xbf16>
    %b_R0_C = nest.alloc slot = "R0_C" role = "inout" shape = [4, 64, 64] dtype = "bf16"
      alignment = 256 : !nest.l2_buffer<4x64x64xbf16>
    %h_R0_C = nest.subview %R0 offsets = [393216] sizes = [16384] strides = [1]
      : !nest.global_view<16384xbf16>
    %b_R1_input = nest.alloc slot = "R1_input" role = "in" shape = [4, 64, 64] dtype = "bf16"
      alignment = 256 : !nest.l2_buffer<4x64x64xbf16>
    %h_R1_input = nest.subview %R1 offsets = [0] sizes = [16384] strides = [1]
      : !nest.global_view<16384xbf16>
    %b_R1_A = nest.alloc slot = "R1_A" role = "inout" shape = [4, 64, 64] dtype = "bf16"
      alignment = 256 : !nest.l2_buffer<4x64x64xbf16>
    %h_R1_A = nest.subview %R1 offsets = [131072] sizes = [16384] strides = [1]
      : !nest.global_view<16384xbf16>
    %b_R1_B = nest.alloc slot = "R1_B" role = "inout" shape = [4, 64, 64] dtype = "bf16"
      alignment = 256 : !nest.l2_buffer<4x64x64xbf16>
    %h_R1_B = nest.subview %R1 offsets = [262144] sizes = [16384] strides = [1]
      : !nest.global_view<16384xbf16>
    %b_R1_C = nest.alloc slot = "R1_C" role = "inout" shape = [4, 64, 64] dtype = "bf16"
      alignment = 256 : !nest.l2_buffer<4x64x64xbf16>
    %h_R1_C = nest.subview %R1 offsets = [393216] sizes = [16384] strides = [1]
      : !nest.global_view<16384xbf16>
    %b_R2_input = nest.alloc slot = "R2_input" role = "in" shape = [4, 64, 64] dtype = "bf16"
      alignment = 256 : !nest.l2_buffer<4x64x64xbf16>
    %h_R2_input = nest.subview %R2 offsets = [0] sizes = [16384] strides = [1]
      : !nest.global_view<16384xbf16>
    %b_R2_A = nest.alloc slot = "R2_A" role = "inout" shape = [4, 64, 64] dtype = "bf16"
      alignment = 256 : !nest.l2_buffer<4x64x64xbf16>
    %h_R2_A = nest.subview %R2 offsets = [131072] sizes = [16384] strides = [1]
      : !nest.global_view<16384xbf16>
    %b_R2_B = nest.alloc slot = "R2_B" role = "inout" shape = [4, 64, 64] dtype = "bf16"
      alignment = 256 : !nest.l2_buffer<4x64x64xbf16>
    %h_R2_B = nest.subview %R2 offsets = [262144] sizes = [16384] strides = [1]
      : !nest.global_view<16384xbf16>
    %b_R2_C = nest.alloc slot = "R2_C" role = "inout" shape = [4, 64, 64] dtype = "bf16"
      alignment = 256 : !nest.l2_buffer<4x64x64xbf16>
    %h_R2_C = nest.subview %R2 offsets = [393216] sizes = [16384] strides = [1]
      : !nest.global_view<16384xbf16>
    %b_R3_input = nest.alloc slot = "R3_input" role = "in" shape = [4, 64, 64] dtype = "bf16"
      alignment = 256 : !nest.l2_buffer<4x64x64xbf16>
    %h_R3_input = nest.subview %R3 offsets = [0] sizes = [16384] strides = [1]
      : !nest.global_view<16384xbf16>
    %b_R3_A = nest.alloc slot = "R3_A" role = "inout" shape = [4, 64, 64] dtype = "bf16"
      alignment = 256 : !nest.l2_buffer<4x64x64xbf16>
    %h_R3_A = nest.subview %R3 offsets = [131072] sizes = [16384] strides = [1]
      : !nest.global_view<16384xbf16>
    %b_R3_B = nest.alloc slot = "R3_B" role = "inout" shape = [4, 64, 64] dtype = "bf16"
      alignment = 256 : !nest.l2_buffer<4x64x64xbf16>
    %h_R3_B = nest.subview %R3 offsets = [262144] sizes = [16384] strides = [1]
      : !nest.global_view<16384xbf16>
    %b_R3_C = nest.alloc slot = "R3_C" role = "inout" shape = [4, 64, 64] dtype = "bf16"
      alignment = 256 : !nest.l2_buffer<4x64x64xbf16>
    %h_R3_C = nest.subview %R3 offsets = [393216] sizes = [16384] strides = [1]
      : !nest.global_view<16384xbf16>
    %pref_W = nest.dma.prefetch.async %h_W into %b_W : !nest.event<"pref_W">
    %pref_R0_input = nest.dma.prefetch.async %h_R0_input into %b_R0_input
      : !nest.event<"pref_R0_input">
    %pref_R1_input = nest.dma.prefetch.async %h_R1_input into %b_R1_input
      : !nest.event<"pref_R1_input">
    ...
    nest.release %b_R0_input depends_on(%read_A0, %pref_R0_input)
    nest.release %b_R1_input depends_on(%read_A1, %pref_R1_input)
    nest.release %b_R2_input depends_on(%read_A2, %pref_R2_input)
    nest.release %b_R3_input depends_on(%read_A3, %pref_R3_input)
    nest.release %b_W depends_on(%read_A0, %read_A1, %read_A2, %read_A3, %pref_W)
    %store_A0 = nest.dma.store.async %b_R0_A into %h_R0_A depends_on(%ready_A0)
      : !nest.event<"store_A0">
    nest.release %b_R0_A depends_on(%read_B0, %store_A0)
    %store_B0 = nest.dma.store.async %b_R0_B into %h_R0_B depends_on(%ready_B0)
      : !nest.event<"store_B0">
    nest.release %b_R0_B depends_on(%read_C0, %store_B0)
    %store_C0 = nest.dma.store.async %b_R0_C into %h_R0_C depends_on(%ready_C0)
      : !nest.event<"store_C0">
    nest.release %b_R0_C depends_on(%store_C0)
    %store_A1 = nest.dma.store.async %b_R1_A into %h_R1_A depends_on(%ready_A1)
      : !nest.event<"store_A1">
    nest.release %b_R1_A depends_on(%read_B1, %store_A1)
    %store_B1 = nest.dma.store.async %b_R1_B into %h_R1_B depends_on(%ready_B1)
      : !nest.event<"store_B1">
    nest.release %b_R1_B depends_on(%read_C1, %store_B1)
    %store_C1 = nest.dma.store.async %b_R1_C into %h_R1_C depends_on(%ready_C1)
      : !nest.event<"store_C1">
    nest.release %b_R1_C depends_on(%store_C1)
    %store_A2 = nest.dma.store.async %b_R2_A into %h_R2_A depends_on(%ready_A2)
      : !nest.event<"store_A2">
    nest.release %b_R2_A depends_on(%read_B2, %store_A2)
    %store_B2 = nest.dma.store.async %b_R2_B into %h_R2_B depends_on(%ready_B2)
      : !nest.event<"store_B2">
    nest.release %b_R2_B depends_on(%read_C2, %store_B2)
    %store_C2 = nest.dma.store.async %b_R2_C into %h_R2_C depends_on(%ready_C2)
      : !nest.event<"store_C2">
    nest.release %b_R2_C depends_on(%store_C2)
    %store_A3 = nest.dma.store.async %b_R3_A into %h_R3_A depends_on(%ready_A3)
      : !nest.event<"store_A3">
    nest.release %b_R3_A depends_on(%read_B3, %store_A3)
    %store_B3 = nest.dma.store.async %b_R3_B into %h_R3_B depends_on(%ready_B3)
      : !nest.event<"store_B3">
    nest.release %b_R3_B depends_on(%read_C3, %store_B3)
    %store_C3 = nest.dma.store.async %b_R3_C into %h_R3_C depends_on(%ready_C3)
      : !nest.event<"store_C3">
    nest.release %b_R3_C depends_on(%store_C3)
    nest.await %grid_A0, %grid_B0, %grid_C0, %grid_A1, %grid_B1, %grid_C1, %grid_A2, %grid_B2,
      %grid_C2, %grid_A3, %grid_B3, %grid_C3, %store_A0, %store_B0, %store_C0, %store_A1, %store_B1,
      %store_C1, %store_A2, %store_B2, %store_C2, %store_A3, %store_B3, %store_C3
    nest.return
  }
  nexus.program @run(
    %R0: !nest.global_memref<4194304xbf16>, %R1: !nest.global_memref<4194304xbf16>,
    %R2: !nest.global_memref<4194304xbf16>, %R3: !nest.global_memref<4194304xbf16>,
    %W: !nest.global_memref<4x64x64xbf16>) {
    %done_all = nexus.submit_context.async @ctx_all_requests(%R0, %R1, %R2, %R3, %W)
      : !nexus.event<"done_all">
