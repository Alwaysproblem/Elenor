...
// case: {"id": "s11", "name": "s11_single", "nodes": ["P0", "P1", "P2", "P3", "R0", "R1", "R", "N0", "N1", "N2", "N3"], "edges": {"R0": ["P0", "P1"], "R1": ["P2", "P3"], "R": ["R0", "R1"], "N0": ["R"], "N1": ["R"], "N2": ["R"], "N3": ["R"]}, "context_partition": [["P0", "P1", "P2", "P3", "R0", "R1", "R", "N0", "N1", "N2", "N3"]], "resource_config": {"uce": 4, "device": 1, "placement": 15, "fidelity": "full_memory"}, "expected": {"时序/生命周期 Correctness": "检查全部真实输入边、完整 Store/release 依赖和 Context 完成", "数值": "未建模；隐式 L1 output timing，仅作合成 compute-cost 扫描", "Liveness": "预期完成", "Scheduling Quality": "以实际 service 判定；不把 issue/slot 占用冒充有效重叠"}, "forbidden_dependencies": "仅允许 edges 与外部输入；跨 Context 使用当前 IR 的保守 context_done 可见性", "tensors": {"input_P0": {"index": 0, "offset_elements": 0, "bytes": 32768}, "W_P0": {"index": 1, "offset_elements": 131072, "bytes": 32768}, "input_P1": {"index": 2, "offset_elements": 262144, "bytes": 32768}, "W_P1": {"index": 3, "offset_elements": 393216, "bytes": 32768}, "input_P2": {"index": 4, "offset_elements": 524288, "bytes": 32768}, "W_P2": {"index": 5, "offset_elements": 655360, "bytes": 32768}, "input_P3": {"index": 6, "offset_elements": 786432, "bytes": 32768}, "W_P3": {"index": 7, "offset_elements": 917504, "bytes": 32768}, "P0": {"index": 8, "offset_elements": 1048576, "bytes": 32768}, "P1": {"index": 9, "offset_elements": 1179648, "bytes": 32768}, "P2": {"index": 10, "offset_elements": 1310720, "bytes": 32768}, "P3": {"index": 11, "offset_elements": 1441792, "bytes": 32768}, "R0": {"index": 12, "offset_elements": 1572864, "bytes": 32768}, "R1": {"index": 13, "offset_elements": 1703936, "bytes": 32768}, "R": {"index": 14, "offset_elements": 1835008, "bytes": 32768}, "N0": {"index": 15, "offset_elements": 1966080, "bytes": 32768}, "N1": {"index": 16, "offset_elements": 2097152, "bytes": 32768}, "N2": {"index": 17, "offset_elements": 2228224, "bytes": 32768}, "N3": {"index": 18, "offset_elements": 2359296, "bytes": 32768}}, "node_programs": {"P0": {"program": "prog_P0", "pin": 0, "engine": "boa", "op": "matmul", "repeat": 1, "loads": 1}, "P1": {"program": "prog_P1", "pin": 1, "engine": "boa", "op": "matmul", "repeat": 1, "loads": 1}, "P2": {"program": "prog_P2", "pin": 2, "engine": "boa", "op": "matmul", "repeat": 1, "loads": 1}, "P3": {"program": "prog_P3", "pin": 3, "engine": "boa", "op": "matmul", "repeat": 1, "loads": 1}, "R0": {"program": "prog_R0", "pin": 0, "engine": "evu", "op": "reduce", "repeat": 1, "loads": 1}, "R1": {"program": "prog_R1", "pin": 2, "engine": "evu", "op": "reduce", "repeat": 1, "loads": 1}, "R": {"program": "prog_R", "pin": 0, "engine": "evu", "op": "reduce", "repeat": 1, "loads": 1}, "N0": {"program": "prog_N0", "pin": 0, "engine": "copy", "op": "copy", "repeat": 1, "loads": 1}, "N1": {"program": "prog_N1", "pin": 1, "engine": "copy", "op": "copy", "repeat": 1, "loads": 1}, "N2": {"program": "prog_N2", "pin": 2, "engine": "copy", "op": "copy", "repeat": 1, "loads": 1}, "N3": {"program": "prog_N3", "pin": 3, "engine": "copy", "op": "copy", "repeat": 1, "loads": 1}}, "consumer_ready": {"P0": ["input_P0.prefetch", "W_P0.prefetch"], "P1": ["input_P1.prefetch", "W_P1.prefetch"], "P2": ["input_P2.prefetch", "W_P2.prefetch"], "P3": ["input_P3.prefetch", "W_P3.prefetch"], "R0": ["P0.output_ready", "P1.output_ready"], "R1": ["P2.output_ready", "P3.output_ready"], "R": ["R0.output_ready", "R1.output_ready"], "N0": ["R.output_ready"], "N1": ["R.output_ready"], "N2": ["R.output_ready"], "N3": ["R.output_ready"]}}
builtin.module {
  ...
  nest.context @ctx_0 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    %grid_P0, %read_P0, %ready_P0 = nest.dispatch.tasks.async @prog_P0 context = 0 tasks(%tasks) globals() ins(%b_input_P0, %b_W_P0, %b_P0) outs(%b_input_P0, %b_W_P0, %b_P0) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%pref_input_P0, %pref_W_P0) : (!nest.event<"grid_P0">, !nest.event<"read_P0">, !nest.event<"ready_P0">)
    %grid_P1, %read_P1, %ready_P1 = nest.dispatch.tasks.async @prog_P1 context = 1 tasks(%tasks) globals() ins(%b_input_P1, %b_W_P1, %b_P1) outs(%b_input_P1, %b_W_P1, %b_P1) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%pref_input_P1, %pref_W_P1) : (!nest.event<"grid_P1">, !nest.event<"read_P1">, !nest.event<"ready_P1">)
    %grid_P2, %read_P2, %ready_P2 = nest.dispatch.tasks.async @prog_P2 context = 2 tasks(%tasks) globals() ins(%b_input_P2, %b_W_P2, %b_P2) outs(%b_input_P2, %b_W_P2, %b_P2) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%pref_input_P2, %pref_W_P2) : (!nest.event<"grid_P2">, !nest.event<"read_P2">, !nest.event<"ready_P2">)
    %grid_P3, %read_P3, %ready_P3 = nest.dispatch.tasks.async @prog_P3 context = 3 tasks(%tasks) globals() ins(%b_input_P3, %b_W_P3, %b_P3) outs(%b_input_P3, %b_W_P3, %b_P3) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%pref_input_P3, %pref_W_P3) : (!nest.event<"grid_P3">, !nest.event<"read_P3">, !nest.event<"ready_P3">)
    %grid_R0, %read_R0, %ready_R0 = nest.dispatch.tasks.async @prog_R0 context = 0 tasks(%tasks) globals() ins(%b_P0, %b_P1, %b_R0) outs(%b_P0, %b_P1, %b_R0) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%ready_P0, %ready_P1) : (!nest.event<"grid_R0">, !nest.event<"read_R0">, !nest.event<"ready_R0">)
    %grid_R1, %read_R1, %ready_R1 = nest.dispatch.tasks.async @prog_R1 context = 2 tasks(%tasks) globals() ins(%b_P2, %b_P3, %b_R1) outs(%b_P2, %b_P3, %b_R1) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%ready_P2, %ready_P3) : (!nest.event<"grid_R1">, !nest.event<"read_R1">, !nest.event<"ready_R1">)
    %grid_R, %read_R, %ready_R = nest.dispatch.tasks.async @prog_R context = 0 tasks(%tasks) globals() ins(%b_R0, %b_R1, %b_R) outs(%b_R0, %b_R1, %b_R) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%ready_R0, %ready_R1) : (!nest.event<"grid_R">, !nest.event<"read_R">, !nest.event<"ready_R">)
    %grid_N0, %read_N0, %ready_N0 = nest.dispatch.tasks.async @prog_N0 context = 0 tasks(%tasks) globals() ins(%b_R, %b_N0) outs(%b_R, %b_N0) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%ready_R) : (!nest.event<"grid_N0">, !nest.event<"read_N0">, !nest.event<"ready_N0">)
    %grid_N1, %read_N1, %ready_N1 = nest.dispatch.tasks.async @prog_N1 context = 1 tasks(%tasks) globals() ins(%b_R, %b_N1) outs(%b_R, %b_N1) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%ready_R) : (!nest.event<"grid_N1">, !nest.event<"read_N1">, !nest.event<"ready_N1">)
    %grid_N2, %read_N2, %ready_N2 = nest.dispatch.tasks.async @prog_N2 context = 2 tasks(%tasks) globals() ins(%b_R, %b_N2) outs(%b_R, %b_N2) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%ready_R) : (!nest.event<"grid_N2">, !nest.event<"read_N2">, !nest.event<"ready_N2">)
    %grid_N3, %read_N3, %ready_N3 = nest.dispatch.tasks.async @prog_N3 context = 3 tasks(%tasks) globals() ins(%b_R, %b_N3) outs(%b_R, %b_N3) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%ready_R) : (!nest.event<"grid_N3">, !nest.event<"read_N3">, !nest.event<"ready_N3">)
    ...
    %store_P0_0 = nest.dma.store.async %b_P0 into %h_P0 depends_on(%ready_P0, %ready_R0) : !nest.event<"store_P0_0">
    nest.release %b_P0 depends_on(%store_P0_0)
    %store_P1_0 = nest.dma.store.async %b_P1 into %h_P1 depends_on(%ready_P1, %ready_R0) : !nest.event<"store_P1_0">
    nest.release %b_P1 depends_on(%store_P1_0)
    %store_P2_0 = nest.dma.store.async %b_P2 into %h_P2 depends_on(%ready_P2, %ready_R1) : !nest.event<"store_P2_0">
    nest.release %b_P2 depends_on(%store_P2_0)
    %store_P3_0 = nest.dma.store.async %b_P3 into %h_P3 depends_on(%ready_P3, %ready_R1) : !nest.event<"store_P3_0">
    nest.release %b_P3 depends_on(%store_P3_0)
    %store_R0_0 = nest.dma.store.async %b_R0 into %h_R0 depends_on(%ready_R0, %ready_R) : !nest.event<"store_R0_0">
    nest.release %b_R0 depends_on(%store_R0_0)
    %store_R1_0 = nest.dma.store.async %b_R1 into %h_R1 depends_on(%ready_R1, %ready_R) : !nest.event<"store_R1_0">
    nest.release %b_R1 depends_on(%store_R1_0)
    %store_R_0 = nest.dma.store.async %b_R into %h_R depends_on(%ready_R, %ready_N0, %ready_N1, %ready_N2, %ready_N3) : !nest.event<"store_R_0">
    ...
    nest.await %grid_P0, %grid_P1, %grid_P2, %grid_P3, %grid_R0, %grid_R1, %grid_R, %grid_N0, %grid_N1, %grid_N2, %grid_N3, %store_P0_0, %store_P1_0, %store_P2_0, %store_P3_0, %store_R0_0, %store_R1_0, %store_R_0, %store_N0_0, %store_N1_0, %store_N2_0, %store_N3_0
    nest.return
  }
