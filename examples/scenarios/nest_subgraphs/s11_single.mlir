...
//         "R0": ["P0.output_ready", "P1.output_ready"],
//         "R1": ["P2.output_ready", "P3.output_ready"],
//         "R": ["R0.output_ready", "R1.output_ready"],
//         "N0": ["R.output_ready"],
//         "N1": ["R.output_ready"],
//         "N2": ["R.output_ready"],
//         "N3": ["R.output_ready"]
...
builtin.module {
  ...
  nest.context @ctx_0 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    nest.await %grid_P0, %grid_P1, %grid_P2, %grid_P3, %grid_R0, %grid_R1, %grid_R, %grid_N0,
      %grid_N1, %grid_N2, %grid_N3, %store_P0_0, %store_P1_0, %store_P2_0, %store_P3_0, %store_R0_0,
      %store_R1_0, %store_R_0, %store_N0_0, %store_N1_0, %store_N2_0, %store_N3_0
    nest.return
  }
