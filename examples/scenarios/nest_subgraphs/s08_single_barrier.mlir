...
//         "Liveness": "预期完成",
//         "Scheduling Quality": "FAIL：刻意在提交 C 和 D 前等待 A/B.ready；工作量、buffer、placement 与正例相同"
//       },
...
//       },
//       "说明": "C 仍真实读取 A/B；D 仍只依赖 B，不等待 C.ready。反例增加的是 A/B ready barrier。"
//     }
builtin.module {
  tile.program @prog_A(
  ...
  nest.context @ctx_0 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    nest.release %b_A depends_on(%read_C, %store_A_0)
