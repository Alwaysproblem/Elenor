...
builtin.module {
  ...
  nest.context @ctx_0 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    %grid_X, %read_X, %ready_X = nest.dispatch.tasks.async @prog_X tasks(%tasks) globals() bindings(%b_input_X, %b_X) ins(%b_input_X) outs(%b_X) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%pref_input_X) : (!nest.event<"grid_X">, !nest.event<"read_X">, !nest.event<"ready_X">)
  ...
  nest.context @ctx_1 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    %tasks = nest.task.range from = 0 to = 4 : !nest.task_range
    %grid_Q, %read_Q, %ready_Q = nest.dispatch.tasks.async @prog_Q tasks(%tasks) globals() bindings(%b_X, %b_W_Q, %b_Q) ins(%b_X, %b_W_Q) outs(%b_Q) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%pref_X, %pref_W_Q) : (!nest.event<"grid_Q">, !nest.event<"read_Q">, !nest.event<"ready_Q">)
    nest.release %b_X depends_on(%read_Q, %pref_X)
  ...
  nest.context @ctx_2 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    %tasks = nest.task.range from = 0 to = 4 : !nest.task_range
    %grid_K, %read_K, %ready_K = nest.dispatch.tasks.async @prog_K tasks(%tasks) globals() bindings(%b_X, %b_W_K, %b_K) ins(%b_X, %b_W_K) outs(%b_K) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%pref_X, %pref_W_K) : (!nest.event<"grid_K">, !nest.event<"read_K">, !nest.event<"ready_K">)
    nest.release %b_X depends_on(%read_K, %pref_X)
  ...
  nest.context @ctx_3 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    %tasks = nest.task.range from = 0 to = 4 : !nest.task_range
    %grid_V, %read_V, %ready_V = nest.dispatch.tasks.async @prog_V tasks(%tasks) globals() bindings(%b_X, %b_W_V, %b_V) ins(%b_X, %b_W_V) outs(%b_V) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%pref_X, %pref_W_V) : (!nest.event<"grid_V">, !nest.event<"read_V">, !nest.event<"ready_V">)
    nest.release %b_X depends_on(%read_V, %pref_X)
  ...
  nest.context @ctx_4 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    %tasks = nest.task.range from = 0 to = 4 : !nest.task_range
    %grid_QK, %read_QK, %ready_QK = nest.dispatch.tasks.async @prog_QK tasks(%tasks) globals() bindings(%b_Q, %b_K, %b_QK) ins(%b_Q, %b_K) outs(%b_QK) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%pref_Q, %pref_K) : (!nest.event<"grid_QK">, !nest.event<"read_QK">, !nest.event<"ready_QK">)
    nest.release %b_Q depends_on(%read_QK, %pref_Q)
    nest.release %b_K depends_on(%read_QK, %pref_K)
  ...
  nest.context @ctx_5 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    %tasks = nest.task.range from = 0 to = 4 : !nest.task_range
    %grid_SM, %read_SM, %ready_SM = nest.dispatch.tasks.async @prog_SM tasks(%tasks) globals() bindings(%b_QK, %b_SM) ins(%b_QK) outs(%b_SM) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%pref_QK) : (!nest.event<"grid_SM">, !nest.event<"read_SM">, !nest.event<"ready_SM">)
    nest.release %b_QK depends_on(%read_SM, %pref_QK)
  ...
  nest.context @ctx_6 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    %tasks = nest.task.range from = 0 to = 4 : !nest.task_range
    %grid_PV, %read_PV, %ready_PV = nest.dispatch.tasks.async @prog_PV tasks(%tasks) globals() bindings(%b_SM, %b_V, %b_PV) ins(%b_SM, %b_V) outs(%b_PV) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%pref_SM, %pref_V) : (!nest.event<"grid_PV">, !nest.event<"read_PV">, !nest.event<"ready_PV">)
    nest.release %b_SM depends_on(%read_PV, %pref_SM)
    nest.release %b_V depends_on(%read_PV, %pref_V)
  ...
  nest.context @ctx_7 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    %tasks = nest.task.range from = 0 to = 4 : !nest.task_range
    %grid_O, %read_O, %ready_O = nest.dispatch.tasks.async @prog_O tasks(%tasks) globals() bindings(%b_PV, %b_O) ins(%b_PV) outs(%b_O) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%pref_PV) : (!nest.event<"grid_O">, !nest.event<"read_O">, !nest.event<"ready_O">)
    nest.release %b_PV depends_on(%read_O, %pref_PV)
