...
builtin.module {
  ...
  nest.context @ctx_even (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    %store_chunk2 = nest.dma.store.async %b_O0 into %h_O2
      depends_on(%ready_Compute0, %ready_Compute2) : !nest.event<"store_chunk2">
  ...
  nest.context @ctx_odd (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    %store_chunk3 = nest.dma.store.async %b_O1 into %h_O3
      depends_on(%ready_Compute1, %ready_Compute3) : !nest.event<"store_chunk3">
