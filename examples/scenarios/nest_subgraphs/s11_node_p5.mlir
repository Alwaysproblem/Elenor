...
// case: {"id": "s11", "name": "s11_node_p5", "nodes": ["P0", "P1", "P2", "P3", "P4", "R0", "R1", "R2", "R", "N0", "N1", "N2", "N3"], "edges": {"R0": ["P0", "P1"], "R1": ["P2", "P3"], "R2": ["R0", "R1"], "R": ["R2", "P4"], "N0": ["R"], "N1": ["R"], "N2": ["R"], "N3": ["R"]}, "context_partition": [["P0"], ["P1"], ["P2"], ["P3"], ["P4"], ["R0"], ["R1"], ["R2"], ["R"], ["N0"], ["N1"], ["N2"], ["N3"]], "resource_config": {"uce": 4, "device": 4, "placement": 15, "fidelity": "full_memory"}, "expected": {"时序/生命周期 Correctness": "检查全部真实输入边、完整 Store/release 依赖和 Context 完成", "数值": "未建模；隐式 L1 output timing，仅作合成 compute-cost 扫描", "Liveness": "预期完成", "Scheduling Quality": "以实际 service 判定；不把 issue/slot 占用冒充有效重叠"}, "forbidden_dependencies": "仅允许 edges 与外部输入；跨 Context 使用当前 IR 的保守 context_done 可见性", "tensors": {"input_P0": {"index": 0, "offset_elements": 0, "bytes": 32768}, "W_P0": {"index": 1, "offset_elements": 131072, "bytes": 32768}, "input_P1": {"index": 2, "offset_elements": 262144, "bytes": 32768}, "W_P1": {"index": 3, "offset_elements": 393216, "bytes": 32768}, "input_P2": {"index": 4, "offset_elements": 524288, "bytes": 32768}, "W_P2": {"index": 5, "offset_elements": 655360, "bytes": 32768}, "input_P3": {"index": 6, "offset_elements": 786432, "bytes": 32768}, "W_P3": {"index": 7, "offset_elements": 917504, "bytes": 32768}, "P0": {"index": 8, "offset_elements": 1048576, "bytes": 32768}, "P1": {"index": 9, "offset_elements": 1179648, "bytes": 32768}, "P2": {"index": 10, "offset_elements": 1310720, "bytes": 32768}, "P3": {"index": 11, "offset_elements": 1441792, "bytes": 32768}, "R0": {"index": 12, "offset_elements": 1572864, "bytes": 32768}, "R1": {"index": 13, "offset_elements": 1703936, "bytes": 32768}, "R": {"index": 14, "offset_elements": 1835008, "bytes": 32768}, "N0": {"index": 15, "offset_elements": 1966080, "bytes": 32768}, "N1": {"index": 16, "offset_elements": 2097152, "bytes": 32768}, "N2": {"index": 17, "offset_elements": 2228224, "bytes": 32768}, "N3": {"index": 18, "offset_elements": 2359296, "bytes": 32768}, "input_P4": {"index": 19, "offset_elements": 2490368, "bytes": 32768}, "W_P4": {"index": 20, "offset_elements": 2621440, "bytes": 32768}, "P4": {"index": 21, "offset_elements": 2752512, "bytes": 32768}, "R2": {"index": 22, "offset_elements": 2883584, "bytes": 32768}}, "node_programs": {"P0": {"program": "prog_P0", "pin": "随 device slot", "engine": "boa", "op": "matmul", "repeat": 1, "loads": 1}, "P1": {"program": "prog_P1", "pin": "随 device slot", "engine": "boa", "op": "matmul", "repeat": 1, "loads": 1}, "P2": {"program": "prog_P2", "pin": "随 device slot", "engine": "boa", "op": "matmul", "repeat": 1, "loads": 1}, "P3": {"program": "prog_P3", "pin": "随 device slot", "engine": "boa", "op": "matmul", "repeat": 1, "loads": 1}, "P4": {"program": "prog_P4", "pin": "随 device slot", "engine": "boa", "op": "matmul", "repeat": 1, "loads": 1}, "R0": {"program": "prog_R0", "pin": "随 device slot", "engine": "evu", "op": "reduce", "repeat": 1, "loads": 1}, "R1": {"program": "prog_R1", "pin": "随 device slot", "engine": "evu", "op": "reduce", "repeat": 1, "loads": 1}, "R2": {"program": "prog_R2", "pin": "随 device slot", "engine": "evu", "op": "reduce", "repeat": 1, "loads": 1}, "R": {"program": "prog_R", "pin": "随 device slot", "engine": "evu", "op": "reduce", "repeat": 1, "loads": 1}, "N0": {"program": "prog_N0", "pin": "随 device slot", "engine": "copy", "op": "copy", "repeat": 1, "loads": 1}, "N1": {"program": "prog_N1", "pin": "随 device slot", "engine": "copy", "op": "copy", "repeat": 1, "loads": 1}, "N2": {"program": "prog_N2", "pin": "随 device slot", "engine": "copy", "op": "copy", "repeat": 1, "loads": 1}, "N3": {"program": "prog_N3", "pin": "随 device slot", "engine": "copy", "op": "copy", "repeat": 1, "loads": 1}}, "consumer_ready": {"P0": ["input_P0.prefetch", "W_P0.prefetch"], "P1": ["input_P1.prefetch", "W_P1.prefetch"], "P2": ["input_P2.prefetch", "W_P2.prefetch"], "P3": ["input_P3.prefetch", "W_P3.prefetch"], "P4": ["input_P4.prefetch", "W_P4.prefetch"], "R0": ["P0.context_done 后从同一 HBM 区间 prefetch", "P1.context_done 后从同一 HBM 区间 prefetch"], "R1": ["P2.context_done 后从同一 HBM 区间 prefetch", "P3.context_done 后从同一 HBM 区间 prefetch"], "R2": ["R0.context_done 后从同一 HBM 区间 prefetch", "R1.context_done 后从同一 HBM 区间 prefetch"], "R": ["R2.context_done 后从同一 HBM 区间 prefetch", "P4.context_done 后从同一 HBM 区间 prefetch"], "N0": ["R.context_done 后从同一 HBM 区间 prefetch"], "N1": ["R.context_done 后从同一 HBM 区间 prefetch"], "N2": ["R.context_done 后从同一 HBM 区间 prefetch"], "N3": ["R.context_done 后从同一 HBM 区间 prefetch"]}, "说明": "5 个 participant；P4 作为奇数尾项直达末层，R0/R1→R2 后与 P4→R，最终 Copy fanout 到 N0..N3。"}
builtin.module {
  ...
  tile.program @prog_P4 (%task: !nest.task, %i0: !nest.l2_buffer<4x64x64xbf16>, %i1: !nest.l2_buffer<4x64x64xbf16>, %out: !nest.l2_buffer<4x64x64xbf16>) {
    %v0 = tile.subview %i0 task = %task task_dim = 0 offsets = [0, 0, 0] sizes = [1, 64, 64] strides = [1, 1, 1] : !nest.l2_view<1x64x64xbf16>
    %l0 = tile.alloc shape = [64, 64] dtype = "bf16" alignment = 256 : !tile.l1_buffer<64x64xbf16>
    %v1 = tile.subview %i1 task = %task task_dim = 0 offsets = [0, 0, 0] sizes = [1, 64, 64] strides = [1, 1, 1] : !nest.l2_view<1x64x64xbf16>
    %l1 = tile.alloc shape = [64, 64] dtype = "bf16" alignment = 256 : !tile.l1_buffer<64x64xbf16>
  ...
  tile.program @prog_R2 (%task: !nest.task, %i0: !nest.l2_buffer<4x64x64xbf16>, %i1: !nest.l2_buffer<4x64x64xbf16>, %out: !nest.l2_buffer<4x64x64xbf16>) {
    %v0 = tile.subview %i0 task = %task task_dim = 0 offsets = [0, 0, 0] sizes = [1, 64, 64] strides = [1, 1, 1] : !nest.l2_view<1x64x64xbf16>
    %l0 = tile.alloc shape = [64, 64] dtype = "bf16" alignment = 256 : !tile.l1_buffer<64x64xbf16>
    %v1 = tile.subview %i1 task = %task task_dim = 0 offsets = [0, 0, 0] sizes = [1, 64, 64] strides = [1, 1, 1] : !nest.l2_view<1x64x64xbf16>
    %l1 = tile.alloc shape = [64, 64] dtype = "bf16" alignment = 256 : !tile.l1_buffer<64x64xbf16>
  ...
  nest.context @ctx_0 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    %grid_P0, %read_P0, %ready_P0 = nest.dispatch.tasks.async @prog_P0 tasks(%tasks) globals() ins(%b_input_P0, %b_W_P0, %b_P0) outs(%b_input_P0, %b_W_P0, %b_P0) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%pref_input_P0, %pref_W_P0) : (!nest.event<"grid_P0">, !nest.event<"read_P0">, !nest.event<"ready_P0">)
    nest.release %b_input_P0 depends_on(%read_P0)
    nest.release %b_W_P0 depends_on(%read_P0)
  ...
  nest.context @ctx_1 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    %tasks = nest.task.range from = 0 to = 4 : !nest.task_range
    %grid_P1, %read_P1, %ready_P1 = nest.dispatch.tasks.async @prog_P1 tasks(%tasks) globals() ins(%b_input_P1, %b_W_P1, %b_P1) outs(%b_input_P1, %b_W_P1, %b_P1) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%pref_input_P1, %pref_W_P1) : (!nest.event<"grid_P1">, !nest.event<"read_P1">, !nest.event<"ready_P1">)
    nest.release %b_input_P1 depends_on(%read_P1)
    nest.release %b_W_P1 depends_on(%read_P1)
  ...
  nest.context @ctx_2 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    %tasks = nest.task.range from = 0 to = 4 : !nest.task_range
    %grid_P2, %read_P2, %ready_P2 = nest.dispatch.tasks.async @prog_P2 tasks(%tasks) globals() ins(%b_input_P2, %b_W_P2, %b_P2) outs(%b_input_P2, %b_W_P2, %b_P2) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%pref_input_P2, %pref_W_P2) : (!nest.event<"grid_P2">, !nest.event<"read_P2">, !nest.event<"ready_P2">)
    nest.release %b_input_P2 depends_on(%read_P2)
    nest.release %b_W_P2 depends_on(%read_P2)
  ...
  nest.context @ctx_3 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    %tasks = nest.task.range from = 0 to = 4 : !nest.task_range
    %grid_P3, %read_P3, %ready_P3 = nest.dispatch.tasks.async @prog_P3 tasks(%tasks) globals() ins(%b_input_P3, %b_W_P3, %b_P3) outs(%b_input_P3, %b_W_P3, %b_P3) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%pref_input_P3, %pref_W_P3) : (!nest.event<"grid_P3">, !nest.event<"read_P3">, !nest.event<"ready_P3">)
    nest.release %b_input_P3 depends_on(%read_P3)
    nest.release %b_W_P3 depends_on(%read_P3)
  ...
  nest.context @ctx_4 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    %b_input_P4 = nest.alloc slot = "input_P4" role = "in" shape = [4, 64, 64] dtype = "bf16" alignment = 256 : !nest.l2_buffer<4x64x64xbf16>
    %h_input_P4 = nest.subview %arena offsets = [2490368] sizes = [16384] strides = [1] : !nest.global_view<16384xbf16>
    %b_W_P4 = nest.alloc slot = "W_P4" role = "in" shape = [4, 64, 64] dtype = "bf16" alignment = 256 : !nest.l2_buffer<4x64x64xbf16>
    %h_W_P4 = nest.subview %arena offsets = [2621440] sizes = [16384] strides = [1] : !nest.global_view<16384xbf16>
    %b_P4 = nest.alloc slot = "P4" role = "inout" shape = [4, 64, 64] dtype = "bf16" alignment = 256 : !nest.l2_buffer<4x64x64xbf16>
    %h_P4 = nest.subview %arena offsets = [2752512] sizes = [16384] strides = [1] : !nest.global_view<16384xbf16>
    %pref_input_P4 = nest.dma.prefetch.async %h_input_P4 into %b_input_P4 : !nest.event<"pref_input_P4">
    %pref_W_P4 = nest.dma.prefetch.async %h_W_P4 into %b_W_P4 : !nest.event<"pref_W_P4">
    %tasks = nest.task.range from = 0 to = 4 : !nest.task_range
    %grid_P4, %read_P4, %ready_P4 = nest.dispatch.tasks.async @prog_P4 tasks(%tasks) globals() ins(%b_input_P4, %b_W_P4, %b_P4) outs(%b_input_P4, %b_W_P4, %b_P4) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%pref_input_P4, %pref_W_P4) : (!nest.event<"grid_P4">, !nest.event<"read_P4">, !nest.event<"ready_P4">)
    nest.release %b_input_P4 depends_on(%read_P4)
    nest.release %b_W_P4 depends_on(%read_P4)
    %store_P4_0 = nest.dma.store.async %b_P4 into %h_P4 depends_on(%ready_P4) : !nest.event<"store_P4_0">
    nest.release %b_P4 depends_on(%store_P4_0)
    nest.await %grid_P4, %store_P4_0
    nest.return
  }
  nest.context @ctx_5 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    %tasks = nest.task.range from = 0 to = 4 : !nest.task_range
    %grid_R0, %read_R0, %ready_R0 = nest.dispatch.tasks.async @prog_R0 tasks(%tasks) globals() ins(%b_P0, %b_P1, %b_R0) outs(%b_P0, %b_P1, %b_R0) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%pref_P0, %pref_P1) : (!nest.event<"grid_R0">, !nest.event<"read_R0">, !nest.event<"ready_R0">)
    nest.release %b_P0 depends_on(%read_R0)
    nest.release %b_P1 depends_on(%read_R0)
  ...
  nest.context @ctx_6 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    %tasks = nest.task.range from = 0 to = 4 : !nest.task_range
    %grid_R1, %read_R1, %ready_R1 = nest.dispatch.tasks.async @prog_R1 tasks(%tasks) globals() ins(%b_P2, %b_P3, %b_R1) outs(%b_P2, %b_P3, %b_R1) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%pref_P2, %pref_P3) : (!nest.event<"grid_R1">, !nest.event<"read_R1">, !nest.event<"ready_R1">)
    nest.release %b_P2 depends_on(%read_R1)
    nest.release %b_P3 depends_on(%read_R1)
  ...
  nest.context @ctx_7 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    %h_R1 = nest.subview %arena offsets = [1703936] sizes = [16384] strides = [1] : !nest.global_view<16384xbf16>
    %b_R2 = nest.alloc slot = "R2" role = "inout" shape = [4, 64, 64] dtype = "bf16" alignment = 256 : !nest.l2_buffer<4x64x64xbf16>
    %h_R2 = nest.subview %arena offsets = [2883584] sizes = [16384] strides = [1] : !nest.global_view<16384xbf16>
    ...
    %tasks = nest.task.range from = 0 to = 4 : !nest.task_range
    %grid_R2, %read_R2, %ready_R2 = nest.dispatch.tasks.async @prog_R2 tasks(%tasks) globals() ins(%b_R0, %b_R1, %b_R2) outs(%b_R0, %b_R1, %b_R2) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%pref_R0, %pref_R1) : (!nest.event<"grid_R2">, !nest.event<"read_R2">, !nest.event<"ready_R2">)
    nest.release %b_R0 depends_on(%read_R2)
    nest.release %b_R1 depends_on(%read_R2)
    %store_R2_0 = nest.dma.store.async %b_R2 into %h_R2 depends_on(%ready_R2) : !nest.event<"store_R2_0">
    nest.release %b_R2 depends_on(%store_R2_0)
    nest.await %grid_R2, %store_R2_0
    nest.return
  }
  nest.context @ctx_8 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    %b_R2 = nest.alloc slot = "R2" role = "in" shape = [4, 64, 64] dtype = "bf16" alignment = 256 : !nest.l2_buffer<4x64x64xbf16>
    %h_R2 = nest.subview %arena offsets = [2883584] sizes = [16384] strides = [1] : !nest.global_view<16384xbf16>
    %b_P4 = nest.alloc slot = "P4" role = "in" shape = [4, 64, 64] dtype = "bf16" alignment = 256 : !nest.l2_buffer<4x64x64xbf16>
    %h_P4 = nest.subview %arena offsets = [2752512] sizes = [16384] strides = [1] : !nest.global_view<16384xbf16>
    ...
    %pref_R2 = nest.dma.prefetch.async %h_R2 into %b_R2 : !nest.event<"pref_R2">
    %pref_P4 = nest.dma.prefetch.async %h_P4 into %b_P4 : !nest.event<"pref_P4">
    %tasks = nest.task.range from = 0 to = 4 : !nest.task_range
    %grid_R, %read_R, %ready_R = nest.dispatch.tasks.async @prog_R tasks(%tasks) globals() ins(%b_R2, %b_P4, %b_R) outs(%b_R2, %b_P4, %b_R) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%pref_R2, %pref_P4) : (!nest.event<"grid_R">, !nest.event<"read_R">, !nest.event<"ready_R">)
    nest.release %b_R2 depends_on(%read_R)
    nest.release %b_P4 depends_on(%read_R)
  ...
  nest.context @ctx_9 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    %tasks = nest.task.range from = 0 to = 4 : !nest.task_range
    %grid_N0, %read_N0, %ready_N0 = nest.dispatch.tasks.async @prog_N0 tasks(%tasks) globals() ins(%b_R, %b_N0) outs(%b_R, %b_N0) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%pref_R) : (!nest.event<"grid_N0">, !nest.event<"read_N0">, !nest.event<"ready_N0">)
    nest.release %b_R depends_on(%read_N0)
  ...
  nest.context @ctx_10 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    %pref_R = nest.dma.prefetch.async %h_R into %b_R : !nest.event<"pref_R">
    %tasks = nest.task.range from = 0 to = 4 : !nest.task_range
    %grid_N1, %read_N1, %ready_N1 = nest.dispatch.tasks.async @prog_N1 tasks(%tasks) globals() ins(%b_R, %b_N1) outs(%b_R, %b_N1) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%pref_R) : (!nest.event<"grid_N1">, !nest.event<"read_N1">, !nest.event<"ready_N1">)
    nest.release %b_R depends_on(%read_N1)
  ...
  nest.context @ctx_11 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    %b_R = nest.alloc slot = "R" role = "in" shape = [4, 64, 64] dtype = "bf16" alignment = 256 : !nest.l2_buffer<4x64x64xbf16>
    %h_R = nest.subview %arena offsets = [1835008] sizes = [16384] strides = [1] : !nest.global_view<16384xbf16>
    ...
    %pref_R = nest.dma.prefetch.async %h_R into %b_R : !nest.event<"pref_R">
    %tasks = nest.task.range from = 0 to = 4 : !nest.task_range
    %grid_N2, %read_N2, %ready_N2 = nest.dispatch.tasks.async @prog_N2 tasks(%tasks) globals() ins(%b_R, %b_N2) outs(%b_R, %b_N2) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%pref_R) : (!nest.event<"grid_N2">, !nest.event<"read_N2">, !nest.event<"ready_N2">)
    nest.release %b_R depends_on(%read_N2)
  ...
  nest.context @ctx_12 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    %b_R = nest.alloc slot = "R" role = "in" shape = [4, 64, 64] dtype = "bf16" alignment = 256 : !nest.l2_buffer<4x64x64xbf16>
    %h_R = nest.subview %arena offsets = [1835008] sizes = [16384] strides = [1] : !nest.global_view<16384xbf16>
    ...
    %pref_R = nest.dma.prefetch.async %h_R into %b_R : !nest.event<"pref_R">
    %tasks = nest.task.range from = 0 to = 4 : !nest.task_range
    %grid_N3, %read_N3, %ready_N3 = nest.dispatch.tasks.async @prog_N3 tasks(%tasks) globals() ins(%b_R, %b_N3) outs(%b_R, %b_N3) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%pref_R) : (!nest.event<"grid_N3">, !nest.event<"read_N3">, !nest.event<"ready_N3">)
    nest.release %b_R depends_on(%read_N3)
  ...
  nexus.program @run (%arena: !nest.global_memref<4194304xbf16>) {
    ...
    nexus.await %done_8
    %done_11 = nexus.submit_context.async @ctx_11(%arena) : !nexus.event<"done_11">
    nexus.await %done_8
    %done_12 = nexus.submit_context.async @ctx_12(%arena) : !nexus.event<"done_12">
    nexus.await %done_0, %done_1, %done_2, %done_3, %done_4, %done_5, %done_6, %done_7, %done_8, %done_9, %done_10, %done_11, %done_12
    nexus.return
  }
}
