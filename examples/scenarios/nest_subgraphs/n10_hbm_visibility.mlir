...
//       "phase": {
//         "A": ["pref_A_input"],
//         "B": ["done_A(context_done)", "pref_A_output_from_same_HBM"],
//         "done_A": ["grid_A", "store_A_9"]
//       },
//       "pins": {
//         "A": "device-slot",
//         "B": "device-slot"
...
builtin.module {
  ...
  nest.context @ctx_A (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    %store_A_0 = nest.dma.store.async %b_A_output into %h_A_output depends_on(%ready_A)
      : !nest.event<"store_A_0">
    nest.await %store_A_0
    %store_A_1 = nest.dma.store.async %b_A_output into %h_A_output depends_on(%ready_A)
      : !nest.event<"store_A_1">
    nest.await %store_A_1
    %store_A_2 = nest.dma.store.async %b_A_output into %h_A_output depends_on(%ready_A)
      : !nest.event<"store_A_2">
    nest.await %store_A_2
    %store_A_3 = nest.dma.store.async %b_A_output into %h_A_output depends_on(%ready_A)
      : !nest.event<"store_A_3">
    nest.await %store_A_3
    %store_A_4 = nest.dma.store.async %b_A_output into %h_A_output depends_on(%ready_A)
      : !nest.event<"store_A_4">
    nest.await %store_A_4
    %store_A_5 = nest.dma.store.async %b_A_output into %h_A_output depends_on(%ready_A)
      : !nest.event<"store_A_5">
    nest.await %store_A_5
    %store_A_6 = nest.dma.store.async %b_A_output into %h_A_output depends_on(%ready_A)
      : !nest.event<"store_A_6">
    nest.await %store_A_6
    %store_A_7 = nest.dma.store.async %b_A_output into %h_A_output depends_on(%ready_A)
      : !nest.event<"store_A_7">
    nest.await %store_A_7
    %store_A_8 = nest.dma.store.async %b_A_output into %h_A_output depends_on(%ready_A)
      : !nest.event<"store_A_8">
    nest.await %store_A_8
    %store_A_9 = nest.dma.store.async %b_A_output into %h_A_output depends_on(%ready_A)
      : !nest.event<"store_A_9">
    nest.release %b_A_output depends_on(
      %store_A_0, %store_A_1, %store_A_2, %store_A_3, %store_A_4, %store_A_5, %store_A_6,
      %store_A_7, %store_A_8, %store_A_9)
