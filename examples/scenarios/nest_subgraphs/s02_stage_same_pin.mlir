...
builtin.module {
  ...
  nest.context @ctx_1 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    %tasks = nest.task.range from = 0 to = 4 : !nest.task_range
    %grid_B0, %read_B0, %ready_B0 = nest.dispatch.tasks.async @prog_B0 context = 0 tasks(%tasks) globals() ins(%b_input_B0, %b_B0) outs(%b_input_B0, %b_B0) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%pref_input_B0) : (!nest.event<"grid_B0">, !nest.event<"read_B0">, !nest.event<"ready_B0">)
    %grid_B1, %read_B1, %ready_B1 = nest.dispatch.tasks.async @prog_B1 context = 0 tasks(%tasks) globals() ins(%b_B0, %b_B1) outs(%b_B0, %b_B1) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%ready_B0) : (!nest.event<"grid_B1">, !nest.event<"read_B1">, !nest.event<"ready_B1">)
  ...
  nest.context @ctx_2 (%arena: !nest.global_memref<4194304xbf16>) placement = 15 {
    ...
    %tasks = nest.task.range from = 0 to = 4 : !nest.task_range
    %grid_C0, %read_C0, %ready_C0 = nest.dispatch.tasks.async @prog_C0 context = 0 tasks(%tasks) globals() ins(%b_input_C0, %b_C0) outs(%b_input_C0, %b_C0) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%pref_input_C0) : (!nest.event<"grid_C0">, !nest.event<"read_C0">, !nest.event<"ready_C0">)
    %grid_C1, %read_C1, %ready_C1 = nest.dispatch.tasks.async @prog_C1 context = 0 tasks(%tasks) globals() ins(%b_C0, %b_C1) outs(%b_C0, %b_C1) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%ready_C0) : (!nest.event<"grid_C1">, !nest.event<"read_C1">, !nest.event<"ready_C1">)
    %grid_C2, %read_C2, %ready_C2 = nest.dispatch.tasks.async @prog_C2 context = 0 tasks(%tasks) globals() ins(%b_C1, %b_C2) outs(%b_C1, %b_C2) signal_policy { input_released = #nest.aggregate<all_tasks>, output_ready = #nest.aggregate<all_tasks> } depends_on(%ready_C1) : (!nest.event<"grid_C2">, !nest.event<"read_C2">, !nest.event<"ready_C2">)
