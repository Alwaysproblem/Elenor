...
builtin.module {
  ...
  nest.context @ctx_a(
    ...
    %5 = nest.subview %YA_in offsets = [0, 0, 0] sizes = [4, 128, 128] strides = [1, 1, 1]
      : !nest.global_view<4x128x128xbf16>
    %6 = nest.subview %YA_out offsets = [0, 0, 0] sizes = [4, 128, 128] strides = [1, 1, 1]
      : !nest.global_view<4x128x128xbf16>
    ...
    %ev_store_a = nest.dma.store.async %inout_buf_a into %6 depends_on(%ev_outready_a)
  ...
  nexus.program @run(
    %YA_in_1: !nest.global_memref<4x128x128xbf16>, %YA_out_1: !nest.global_memref<4x128x128xbf16>,
    %YB_1: !nest.global_memref<4x128x128xbf16>) {
