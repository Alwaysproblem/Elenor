...
builtin.module {
  ...
  nest.context @ctx_a (%YA_in: !nest.global_memref<4x128x128xbf16>, %YA_out: !nest.global_memref<4x128x128xbf16>) placement = 15 {
    ...
    nest.release %inout_buf_a depends_on(%ev_pref_out, %ev_store_a)
  ...
  nest.context @ctx_b (%YB: !nest.global_memref<4x128x128xbf16>) placement = 15 {
    ...
    %ev_grid_b, %ev_inrel_b, %10 = nest.dispatch.tasks.async @prog_b tasks(%9) globals() bindings(%in_buf_b) ins(%in_buf_b) outs() signal_policy { input_released = #nest.aggregate<all_tasks> } depends_on(%ev_pref_b) : (!nest.event<"ev_grid_b">, !nest.event<"ev_inrel_b">, !nest.event<"">)
