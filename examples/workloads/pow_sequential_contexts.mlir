builtin.module {
  ...
  nest.context @pow_ctx0 (%Y: !nest.global_memref<4x128x128xbf16>) placement = 15 {
    ...
    %ev_out = nest.dma.store.async %l2_buf_1 into %2 depends_on(%ev_outready)
      : !nest.event<"ev_out">
  ...
  nest.context @pow_ctx1 (%Y_1: !nest.global_memref<4x128x128xbf16>) placement = 15 {
    ...
    %ev_grid_1, %ev_inrel_1, %ev_outready_1 =
      ...
      signal_policy {
        ...
        : (!nest.event<"ev_grid_1">, !nest.event<"ev_inrel_1">, !nest.event<"ev_outready_1">)
    %ev_out_1 = nest.dma.store.async %l2_buf_2 into %4 depends_on(%ev_outready_1)
      : !nest.event<"ev_out_1">
